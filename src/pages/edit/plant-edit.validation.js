const plantEditValidation = ({ name, last_watering_date, has_moisture_sensor, sensor_id, watering_frequency, need_watering_frequency }, t) => {
  const errors = {};
...
export default plantEditValidation;
